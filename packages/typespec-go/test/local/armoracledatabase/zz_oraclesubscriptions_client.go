...
// Don't use this type directly, use [DatabaseClient.NewOracleSubscriptionsClient] instead.
...
func (client *OracleSubscriptionsClient) ListCloudAccountDetails(ctx context.Context, options *OracleSubscriptionsClientListCloudAccountDetailsOptions) (OracleSubscriptionsClientListCloudAccountDetailsResponse, error) {
	var err error
	const operationName = "OracleSubscriptionsClient.ListCloudAccountDetails"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.listCloudAccountDetailsCreateRequest(ctx, options)
	if err != nil {
		return OracleSubscriptionsClientListCloudAccountDetailsResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return OracleSubscriptionsClientListCloudAccountDetailsResponse{}, err
	...
	resp, err := client.listCloudAccountDetailsHandleResponse(httpResp)
	return resp, err
}

// listCloudAccountDetailsCreateRequest creates the ListCloudAccountDetails request.
func (client *OracleSubscriptionsClient) listCloudAccountDetailsCreateRequest(ctx context.Context, _ *OracleSubscriptionsClientListCloudAccountDetailsOptions) (*policy.Request, error) {
...
// listCloudAccountDetailsHandleResponse handles the ListCloudAccountDetails response.
func (client *OracleSubscriptionsClient) listCloudAccountDetailsHandleResponse(resp *http.Response) (OracleSubscriptionsClientListCloudAccountDetailsResponse, error) {
	result := OracleSubscriptionsClientListCloudAccountDetailsResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.CloudAccountDetails); err != nil {
		return OracleSubscriptionsClientListCloudAccountDetailsResponse{}, err
	}
	return result, nil
}
