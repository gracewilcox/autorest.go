...
//     method.
func (client *CloudHsmClustersClient) CloudHsmClusterBackupStatusGet(ctx context.Context, resourceGroupName string, cloudHsmClusterName string, jobID string, options *CloudHsmClustersClientCloudHsmClusterBackupStatusGetOptions) (CloudHsmClustersClientCloudHsmClusterBackupStatusGetResponse, error) {
	var err error
	const operationName = "CloudHsmClustersClient.CloudHsmClusterBackupStatusGet"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.cloudHsmClusterBackupStatusGetCreateRequest(ctx, resourceGroupName, cloudHsmClusterName, jobID, options)
	if err != nil {
		return CloudHsmClustersClientCloudHsmClusterBackupStatusGetResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return CloudHsmClustersClientCloudHsmClusterBackupStatusGetResponse{}, err
	...
	resp, err := client.cloudHsmClusterBackupStatusGetHandleResponse(httpResp)
	return resp, err
}

// cloudHsmClusterBackupStatusGetCreateRequest creates the CloudHsmClusterBackupStatusGet request.
func (client *CloudHsmClustersClient) cloudHsmClusterBackupStatusGetCreateRequest(ctx context.Context, resourceGroupName string, cloudHsmClusterName string, jobID string, _ *CloudHsmClustersClientCloudHsmClusterBackupStatusGetOptions) (*policy.Request, error) {
...
//   - options - CloudHsmClustersClientCloudHsmClusterRestoreStatusGetOptions contains the optional parameters for the CloudHsmClustersClient.CloudHsmClusterRestoreStatusGet
//     method.
func (client *CloudHsmClustersClient) CloudHsmClusterRestoreStatusGet(ctx context.Context, resourceGroupName string, cloudHsmClusterName string, jobID string, options *CloudHsmClustersClientCloudHsmClusterRestoreStatusGetOptions) (CloudHsmClustersClientCloudHsmClusterRestoreStatusGetResponse, error) {
	var err error
	const operationName = "CloudHsmClustersClient.CloudHsmClusterRestoreStatusGet"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.cloudHsmClusterRestoreStatusGetCreateRequest(ctx, resourceGroupName, cloudHsmClusterName, jobID, options)
	if err != nil {
		return CloudHsmClustersClientCloudHsmClusterRestoreStatusGetResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return CloudHsmClustersClientCloudHsmClusterRestoreStatusGetResponse{}, err
	...
	resp, err := client.cloudHsmClusterRestoreStatusGetHandleResponse(httpResp)
	return resp, err
}

// cloudHsmClusterRestoreStatusGetCreateRequest creates the CloudHsmClusterRestoreStatusGet request.
func (client *CloudHsmClustersClient) cloudHsmClusterRestoreStatusGetCreateRequest(ctx context.Context, resourceGroupName string, cloudHsmClusterName string, jobID string, _ *CloudHsmClustersClientCloudHsmClusterRestoreStatusGetOptions) (*policy.Request, error) {
...
//   - cloudHsmClusterName - The name of the Cloud HSM Cluster within the specified resource group. Cloud HSM Cluster names must
//     be between 3 and 23 characters in length.
//   - options - CloudHsmClustersClientListByCloudHsmClusterOptions contains the optional parameters for the CloudHsmClustersClient.NewListByCloudHsmClusterPager
//     method.
func (client *CloudHsmClustersClient) NewListByCloudHsmClusterPager(resourceGroupName string, cloudHsmClusterName string, options *CloudHsmClustersClientListByCloudHsmClusterOptions) *runtime.Pager[CloudHsmClustersClientListByCloudHsmClusterResponse] {
	return runtime.NewPager(runtime.PagingHandler[CloudHsmClustersClientListByCloudHsmClusterResponse]{
		More: func(page CloudHsmClustersClientListByCloudHsmClusterResponse) bool {
			return page.NextLink != nil && len(*page.NextLink) > 0
		},
		Fetcher: func(ctx context.Context, page *CloudHsmClustersClientListByCloudHsmClusterResponse) (CloudHsmClustersClientListByCloudHsmClusterResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "CloudHsmClustersClient.NewListByCloudHsmClusterPager")
			nextLink := ""
			if page != nil {
			...
			if err != nil {
				return CloudHsmClustersClientListByCloudHsmClusterResponse{}, err
			}
...
func (client *CloudHsmClustersClient) listByCloudHsmClusterCreateRequest(ctx context.Context, resourceGroupName string, cloudHsmClusterName string, _ *CloudHsmClustersClientListByCloudHsmClusterOptions) (*policy.Request, error) {
...
func (client *CloudHsmClustersClient) listByCloudHsmClusterHandleResponse(resp *http.Response) (CloudHsmClustersClientListByCloudHsmClusterResponse, error) {
	result := CloudHsmClustersClientListByCloudHsmClusterResponse{}
