...
// Don't use this type directly, use [CommunityClient.NewCommunityTrainingsClient] instead.
...
func (client *CommunityTrainingsClient) createCreateRequest(ctx context.Context, resourceGroupName string, communityTrainingName string, resource CommunityTraining, _ *CommunityTrainingsClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *CommunityTrainingsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, communityTrainingName string, _ *CommunityTrainingsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Community/communityTrainings/{communityTrainingName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *CommunityTrainingsClient) getCreateRequest(ctx context.Context, resourceGroupName string, communityTrainingName string, _ *CommunityTrainingsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Community/communityTrainings/{communityTrainingName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *CommunityTrainingsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *CommunityTrainingsClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *CommunityTrainingsClient) listBySubscriptionCreateRequest(ctx context.Context, _ *CommunityTrainingsClientListBySubscriptionOptions) (*policy.Request, error) {
