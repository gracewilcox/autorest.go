...
// Don't use this type directly, use [MethodSubscriptionIDClient.NewOperationsClient] instead.
...
func (client *OperationsClient) listCreateRequest(ctx context.Context, _ *OperationsClientListOptions) (*policy.Request, error) {
	urlPath := "/providers/Azure.ResourceManager.MethodSubscriptionId/operations"
