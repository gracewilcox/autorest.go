...
// Don't use this type directly, use [OperationTemplatesClient.NewOperationsClient] instead.
...
func (client *OperationsClient) listCreateRequest(ctx context.Context, _ *OperationsClientListOptions) (*policy.Request, error) {
	urlPath := "/providers/Azure.ResourceManager.OperationTemplates/operations"
